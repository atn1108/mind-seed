...
const VI: Record<string, string> = {
  ...
  Species: "Loài cây", "Forest history": "Lịch sử khu rừng", "Focus Insight": "Phân tích tập trung", "Your last 7-day focus report.": "Báo cáo tập trung 7 ngày qua.", "Focus time by day": "Thời gian tập trung theo ngày", "Study windows": "Khung giờ học", "4-week trend": "Xu hướng 4 tuần", "MindSeed analysis": "Phân tích MindSeed", "Monthly goal": "Mục tiêu tháng", "Focus journal": "Nhật ký tập trung",
